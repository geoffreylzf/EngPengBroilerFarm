...
public class TempFeedReceiveDetailHouseAdapter extends RecyclerView.Adapter<TempFeedReceiveDetailHouseAdapter.HouseViewHolder>{

    private Context mContext;
    private List<HouseCode> mHouseList;

    public TempFeedReceiveDetailHouseAdapter(Context context, List<HouseCode> houseList) {
    ...
    public HouseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = li.inflate(R.layout.list_item_temp_feed_receive_detail_house, parent, false);
        return new TempFeedReceiveDetailHouseAdapter.HouseViewHolder(view);
    }


    @Override
    public void onBindViewHolder(final TempFeedReceiveDetailHouseAdapter.HouseViewHolder holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TempFeedReceiveDetailHouseAdapter.this.notifyDataSetChanged();
            }
        });
    ...
    class HouseViewHolder extends RecyclerView.ViewHolder {
        ...
        public HouseViewHolder(View itemView) {
            super(itemView);
            view = itemView;
            tvHouseCode = itemView.findViewById(R.id.li_temp_feed_receive_detail_house_house_code);
            cbSelect = itemView.findViewById(R.id.li_temp_feed_receive_detail_house_cb);
        }
